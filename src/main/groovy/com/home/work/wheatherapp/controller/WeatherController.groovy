package com.home.work.wheatherapp.controller
...
class WeatherController {
   ...
   @Value('${kafka.weather.topic}') String topic
    ...
    @RequestMapping(value = '/details', produces = "applicaation/json")
    WeatherResponse getWeatherDetails(float lang,float lat){
